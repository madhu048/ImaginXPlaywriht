...
module.exports = async () => {
  ...
  try {
        await fs.emptyDir(failedUrls); // Clears all files from screenshots folder
        console.log(`🧹 Cleared '${failedUrls}' folder.`);
      } catch (err) {
        console.error(`❌ Error clearing '${failedUrls}':`, err);
      }
};
