...
test('Home Page', async({page},testInfo)=>{
    if(await urlStatus(page)){
        ...
        // header checking
        const headerCoRes = await elementCoordinates(page,"//h1[contains(normalize-space(),'Empowering Tomorrow')]",370.40625,368,"Header","Home");
        ...
        if(experienceInnovationButton){
                        ...
                        // await experienceInnovationButton.waitFor({timeout:40000});
        ...
        if(EducationButton){
            ...
            if(viewMoreButton){
                        ...
                        // await viewMoreButton.waitFor({timeout:40000});
        ...
        //     await ele.waitFor({timeout:40000});
            ...
            if(viewMoreButton){
                        ...
                        const workforcePageHeadr = await elementCheck(page,testInfo,"(//h1[contains(normalize-space(),'Workforce Development')]/span[contains(normalize-space(),'Solutions')])[1]","workforcePageHeadr","Workforce");
...
test('IXGenie Page',async({page},testInfo)=>{
    if(await urlStatus(page)){
            try {
                ...
                //     await ixgenieButton.waitFor({timeout:40000});
                //     await ixgenieButton.click();
                    ...
                    const headerCoRes = await elementCoordinates(page,"(//h1[contains(normalize-space(),'iXGenie the Ultimate Training & Learning Platform')])[1]",175.0625,492,"Header","IXGenie");
                    expect.soft(headerCoRes).toBeTruthy();
                    // Banner video checking
                ...
                //     if(!videoRes){await takeScreenshotEle(page,"//video","IXgeniePageBannerVideo")};
                    ...
                    if(assetManagementProcessVideoThumbnail){
                        ...
                        if(assetManagementProcessVideoPopUp){
                            ...
                            const assetManagementProcessVideo = await isvideoWithSrcPlaying(page,testInfo,"https://www.imaginxavr.com/uploads/videos/asset-management-process17466245198830021746624519.mp4","assetManagementProcessVideo","IXgenie",5000,false);
                        ...
                        //     await assetManagementProcessVideoCloseButton.waitFor({timeout:40000});
                    ...
                    if(MachineInstallationWithAIVideoThumbnail){
                        ...
                        if(MachineInstallationWithAIVideoPopUp){
                            // it will check the video is playing or not
                            const MachineInstallationWithAIVideo = await isvideoWithSrcPlaying(page,testInfo,"https://www.imaginxavr.com/uploads/videos/filtrex-with-ai17455870359219241745587035.mp4","MachineInstallationWithAIVideo","IXgenie",5000,false);
                        ...
                        //     await MachineInstallationWithAIVideoCloseButton.waitFor({timeout:40000});
                    ...
                    if(CollegeVirtualTourVideoThumbnail){
                        // const img = await page.locator("//img[@src='https://www.imaginxavr.com/uploads/videos/college--virtual-tour-17466237137678411746623713.jpg']");
                        // await img.waitFor({timeout:40000});
                        ...
                        if(CollegeVirtualTourVideoPopUp){
                            // it will check the video is playing or not
                            const CollegeVirtualTourVideo = await isvideoWithSrcPlaying(page,testInfo,"https://www.imaginxavr.com/uploads/videos/college--virtual-tour-17466236458159011746623645.mp4","CollegeVirtualTourVideo","IXgenie",5000,false);
                        ...
                        //     await CollegeVirtualTourVideoCloseButton.waitFor({timeout:40000});
                    ...
                    if(HumanAnatomyVideoThumbnail){
                        // const imgEle = await page.locator("//img[@src='https://www.imaginxavr.com/uploads/videos/human-anatomy17466411323603661746641132.jpg']");
                        // await imgEle.waitFor({timeout:40000});
                        ...
                        if(HumanAnatomyVideoPopUp){
                            // it will check the video is playing or not
                            const HumanAnatomyVideo = await isvideoWithSrcPlaying(page,testInfo,"https://www.imaginxavr.com/uploads/videos/human-anatomy17466411329077561746641132.mp4","HumanAnatomyVideo","IXgenie",5000,false);
                        ...
                        //     await HumanAnatomyVideoCloseButton.waitFor({timeout:40000});
                    ...
                    if(ViewMoreButton){
                        ...
                        // await viewButton.waitFor({timeout:40000});
                        const res = await hoverAndClickWithXpath(page,"//a[normalize-space()='View More']");
                        expect.soft(res).toBeTruthy();
...
test('Edmentor AI Page',async({page},testInfo)=>{
    if(await urlStatus(page)){
            try {
                ...
                //     await EdmentorAIButton.waitFor({timeout:40000});
                //     await EdmentorAIButton.click();
                    ...
                    const headerCoRes = await elementCoordinates(page,"//h1[normalize-space()='Edmentor AI']",576,194,"Header","Edmentor AI");
                    expect.soft(headerCoRes).toBeTruthy();
                    // Header checking
                    ...
                    if(DataProtectionPrivacyPolicyButton){
                        ...
                        // await DataProtectionPrivacyPolicyButton.waitFor({timeout:40000});
                    ...
                    if(ContactUsButton){
                        ...
                        // await contactButton.waitFor({timeout:40000});
...
test('Educational Page',async({page},testInfo)=>{
    if(await urlStatus(page)){
            try {
                //     const solutionEle =  await page.locator("xpath=(//a[normalize-space()='Solutions'])[1]");
                //     await solutionEle.waitFor({timeout:40000});   
                //     await solutionEle.hover();
                ...
                //     await EducationalButton.waitFor({timeout:40000});
                    ...
                    expect.soft(videoRes).toBeTruthy();
                    // header checking
                    const headerCoRes = await elementCoordinates(page,"(//h1[contains(normalize-space(),'Immersive Learning ')])[1]",487.515625,274,"Header","Educational");
                    expect.soft(headerCoRes).toBeTruthy();
                ...
                //      await page.locator("//p[normalize-space()='Our Recent Posts']").hover();
                     ...
                     // Interactive Unity Container checking
                //      const interactiveUnityContainer = await elementCheck(frame,testInfo,"//div[@id='unity-container']","interactiveUnityContainer","Educational");
                ...
                //      const CessnaWheelUnityBuildTitleEle = await frame.locator("//div[@id='unity-build-title']");
                //      await CessnaWheelUnityBuildTitleEle.waitFor({timeout:40000});
                //      const CessnaWheelUnityBuildTitle = await CessnaWheelUnityBuildTitleEle.innerText();
...
test('Workforce Development Page',async({page},testInfo)=>{
    if(await urlStatus(page)){
            try {
                ...
                //     await WorkforceDevelopmentButton.waitFor({timeout:40000});
                    ...
                    expect.soft(videoRes).toBeTruthy();
                    // header checking
                    const headerCoRes = await elementCoordinates(page,"(//h1[contains(normalize-space(),'Workforce Development ')])[1]",414.0625,274,"Header","Workforce Development");
                    expect.soft(headerCoRes).toBeTruthy();
...
test('Industrial Page',async({page},testInfo)=>{
    if(await urlStatus(page)){
            try {
                ...
                //     await IndustrialButton.waitFor({timeout:40000});
                    ...
                    expect.soft(videoRes).toBeTruthy();
                    // header checking
                    const headerCoRes =  await elementCoordinates(page,"(//h1[contains(normalize-space(),'Industrial Training')])[1]",514.765625,274,"Header","Industrial");
                    expect.soft(headerCoRes).toBeTruthy();
...
test('Healthcare Page',async({page},testInfo)=>{
    if(await urlStatus(page)){
            try {
                ...
                //     await HealthcareButton.waitFor({timeout:40000});
                ...
                //     if(!videoRes){await takeScreenshotEle(page,"//video","HealthcarePageBannerVideo")};
                    expect.soft(videoRes).toBeTruthy();
                    // header checking
                    const headerCoRes = await elementCoordinates(page,"(//h1[contains(normalize-space(),'Healthcare Training')])[1]",489.53125,274,"Header","Healthcare");
                    expect.soft(headerCoRes).toBeTruthy();
...
test('Case Studies Page',async({page},testInfo)=>{
    if(await urlStatus(page)){
            try {
                //     const solutionsEle =  await page.locator("xpath=(//a[normalize-space()='Solutions'])[1]");
                //     await solutionsEle.waitFor({timeout:40000});    
                //     await solutionsEle.hover();
                ...
                //     await CaseStudiesButton.waitFor({timeout:40000});
                    ...
                    for(let i=0; i<educationVideosCount; i++){
                        ...
                        // const videoNameEle = await video.locator("xpath=/a/div[2]/h4");
                        // await videoNameEle.waitFor({timeout:40000});
                        // let videoName = await videoNameEle.innerText();
                        const videoName = await getInnerTextWithXpath(video,"xpath=/a/div[2]/h4");
                        console.log(`Video name : ${videoName}`);
                        // const videoThumbNailSrcEle = await video.locator("xpath=/a/div[1]/img");
                        // await videoThumbNailSrcEle.waitFor({timeout:40000});
                        // let videoThumbNailSrc = await videoThumbNailSrcEle.getAttribute("src");
                        ...
                        expect.soft(res7).toBeTruthy();
                        // const videoSrcEle = await page.locator("//video/source");
                        // // await videoSrcEle.waitFor({timeout:40000}); // here it is not working don't know reason
                        // const videoSrc = await videoSrcEle.getAttribute("src");
                        const videoSrc = await getAttributeWithXpath(page,"//video/source","src");
                        console.log(`${videoName} src : ${videoSrc}`);
                        const videoResult = await isvideoWithSrcPlaying(page,testInfo,videoSrc,videoName,"CaseStudies",5000,false);
                        ...
                        // await VideoCloseButton.waitFor({timeout:40000});
                    ...
                    if(industrialTraingButton){
                        ...
                        // await industrialTraingButton.waitFor({timeout:40000});
                    ...
                    if(VirtualTourButton){
                        ...
                        // await VirtualTourButton.waitFor({timeout:40000});
...
test('Community Page',async({page},testInfo)=>{
    if(await urlStatus(page)){
            try {
                ...
                //     await CommunityButton.waitFor({timeout:40000});
                //     await CommunityButton.click();
                    ...
                    for(let i=0; i<blogsCount;i++){
                        ...
                        // const blogImageSrcEle = await blog.locator("xpath=/div[contains(@class,'Img')]/img");
                        // await blogImageSrcEle.waitFor({timeout:40000});
                        // const blogImageSrc = await blogImageSrcEle.getAttribute("src");
                        ...
                        // const blogTitleEle = await blog.locator("xpath=/div[contains(@class,'Content')]/h3");
                        // await blogTitleEle.waitFor({timeout:40000});
                        // const blogTitle = await blogTitleEle.innerText();
                        ...
                        // const blogParaEle = await blog.locator("xpath=/div[contains(@class,'Content')]/p[contains(@class,'Para')]");
                        // await blogParaEle.waitFor({timeout:40000});
                        // const blogPara = await blogParaEle.innerText();
                        ...
                        // const blogReadMoreEle = await blog.locator("xpath=/div[contains(@class,'Content')]/a[normalize-space()='Read More']");
                        // await blogReadMoreEle.waitFor({timeout:40000});
                        // const blogReadMore = await blogReadMoreEle.innerText();
                        ...
                        if(blogReadMore && !blogReadMore.startsWith("⚠️")){
                                ...
                                // await ReadMoreButton.waitFor({timeout:40000});
                                // await ReadMoreButton.click()
                                // const res = await hoverAndClickWithXpath(blog,"xpath=/div[contains(@class,'Content')]/a[normalize-space()='Read More']");
                                ...
                                await page.waitForTimeout(1000);
                                // const blogHeaderEle = await page.locator("//h1[contains(@class,'Title')]");
                                // await blogHeaderEle.waitFor({timeout:40000});
                                // const blogHeader = await blogHeaderEle.innerText();
...
test('FAQ Page',async({page},testInfo)=>{
    if(await urlStatus(page)){
            try {
                ...
                //     await FAQButton.waitFor({timeout:40000});
...
test('Contact Us Page',async({page},testInfo)=>{
    if(await urlStatus(page)){
            try {
                ...
                //     await ContactUsButton.waitFor({timeout:40000});
                ...
                //     await code.waitFor({timeout:40000});
...
test('Blogs Page',async({page},testInfo)=>{
    if(await urlStatus(page)){
            try {
                ...
                //     await BlogsButton.waitFor({timeout:40000});
                    ...
                    for(let i=0; i<blogsCount;i++){
                        ...
                        if(blogReadMore){
                                ...
                                // const ReadMoreButton = blog.locator("xpath=/div[contains(@class,'Content')]/a[normalize-space()='Read More']");
                                // await ReadMoreButton.waitFor({timeout:40000});
                                // await hoverAndClickWithXpath(blog,"xpath=/div[contains(@class,'Content')]/a[normalize-space()='Read More']");
...
test('Privacy Policy Page',async({page},testInfo)=>{
    if(await urlStatus(page)){
            try {
                ...
                //     await PrivacyPolicyButton.waitFor({timeout:40000});
                    ...
                    for(let i=0;i<await policyPoints.count();i++){
                        ...
                        // const policyPointEle = await policyPoint.locator("xpath=/h3");
                        // await policyPointEle.waitFor({timeout:40000});
                        // const policyPointText = await policyPointEle.innerText();
